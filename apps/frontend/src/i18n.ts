  ...
  en: {
    translation: {
      ...
      companies: {
        ...
        update_failed: 'Update failed',
        delete_failed: 'Delete failed',
        delete_confirm: 'Delete company? This cannot be undone.',
      },
      deals: {
        title: 'Deals',
        new: 'New Deal',
  ...
  es: {
    translation: {
      ...
      companies: {
        ...
        update_failed: 'Fallo al actualizar',
        delete_failed: 'Fallo al eliminar',
        delete_confirm: '¿Eliminar empresa? Esto no se puede deshacer.',
      },
      deals: {
        title: 'Oportunidades',
  ...
  fr: {
    translation: {
      ...
      companies: {
        ...
        update_failed: 'Échec de la mise à jour',
        delete_failed: 'Échec de la suppression',
        delete_confirm: 'Supprimer l’entreprise ? Cette action est irréversible.',
      },
      deals: {
        title: 'Affaires',
        new: 'Nouvelle Affaire',
        search: 'Rechercher des affaires',
